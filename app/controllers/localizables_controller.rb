class LocalizablesController < ApplicationController
  ...
  def create
    ...
    @localizable.app_id = params[:number][:app_id]
    respond_to do |format|
      if @localizable.save
        format.html { redirect_to localizable_path(@localizable.app_id), notice: 'Localizable was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @localizable.update(localizable_params)
        format.html { redirect_to localizable_path, notice: 'Localizable was successfully updated.' }
  ...
  def destroy
    ...
    @localizable.destroy
    respond_to do |format|
      format.html { redirect_to localizables_path(app_id) }
